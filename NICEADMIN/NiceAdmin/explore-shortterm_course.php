...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  $course_type = "shortterm"; // Set the course_type to 'shortterm'
  ...
  if (empty($board) || empty($grade) || empty($program) || empty($duration)) {
      ...
      if ($course_type === 'shortterm') {
          ...
          $updateStatus = "Course type is not 'shortterm'. Data not inserted.";
      }
  }
}
...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Short Term Course</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="./admin_register.php">Home</a></li>
        <li class="breadcrumb-item">Admin</li>
        <li class="breadcrumb-item active">Short Term Course</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section dashboard">
    <div class="row">
      ...
      $query112 = "SELECT * FROM courses where course_type='shortterm'";
                    ...
                    $serialNumber = 1;
                      echo "<table class='table table-bordered' style='width:100%;'>
                        ...
                        <tbody>";
                          ...
                          <a style="text-decoration:none; " href="#" data-bs-toggle="modal" data-bs-target="#addModal"  data-grade=' . $result["course_id"] . '">
   
                          <a style="text-decoration:none; " href="delete3.php?id=' . $result["course_id"] . '">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="addModalLabel">New ShortTerm Course Add</h5>
