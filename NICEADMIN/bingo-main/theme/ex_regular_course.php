...
<section class="single-page-header">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2><?php echo isset($result['regular']) ? $result['regular'] : "Regular Course"; ?></h2>
        <ol class="breadcrumb header-bradcrumb justify-content-center">
          <li class="breadcrumb-item"><a href="index.php" class="text-white"><?php echo isset($result['home']) ? $result['home'] : "Home"; ?></a></li>
          <li class="breadcrumb-item active" aria-current="page"><?php echo isset($result['regular']) ? $result['regular'] : "Regular Course"; ?></li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="row justify-content-center">
      <div class="row height_manage">
        ...
        <div class="col-8 grid2">
          ...
          ?>
          <h2><?php echo isset($result['regular']) ? $result['regular'] : "Regular Course"; ?></h2>
          <?php echo isset($collecteddata['regular']) ? $collecteddata['regular'] : " “The most common way people give up their power is by thinking they don’t have any option.”
...
$api_url = 'http://localhost/pp_classes/NiceAdmin/API/regularcourse.php';
