...
<section class="single-page-header">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2><?php echo isset($result['shortterm']) ? $result['shortterm'] : "Shortterm Course"; ?></h2>
        <ol class="breadcrumb header-bradcrumb justify-content-center">
          <li class="breadcrumb-item"><a href="index.php" class="text-white"><?php echo isset($result['home']) ? $result['home'] : "Home"; ?></a></li>
          <li class="breadcrumb-item active" aria-current="page"><?php echo isset($result['shortterm']) ? $result['shortterm'] : "Shortterm Course"; ?></li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="row justify-content-center">
      <div class="row height_manage">
        ...
        <div class="col-8 grid2">
          ...
          ?>
          <h2><?php echo isset($result['shortterm']) ? $result['shortterm'] : "Shortterm Course"; ?></h2>
          <?php echo isset($collecteddata['shortterm']) ? $collecteddata['shortterm'] : " “The most common way people give up their power is by thinking they don’t have any option.”
...
<?php
// API URL to fetch short term course data
$api_url = 'http://localhost/pp_classes/NiceAdmin/API/shortterm.php';
$data = file_get_contents($api_url);
$shorttermcourses = json_decode($data, true);
?>
<br>
<div class="container">
    ...
    <div class="row justify-content-center">
      <div class="row height_manage col-12">
        ...
        if (!empty($shorttermcourses)) {
          ...
          foreach ($shorttermcourses as $result) {
            echo '<tr>
